...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1697403447ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=inventario&table=registro">`inventario`.`registro`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=inventario&table=producto">`inventario`.`producto`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=inventario&table=categoria_productos">`inventario`.`categoria_productos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tareaslaravel&table=tareas">`tareaslaravel`.`tareas`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=administrador&table=estudiantes">`administrador`.`estudiantes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=administrador&table=cursos">`administrador`.`cursos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=administrador&table=docentes">`administrador`.`docentes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=administrador&table=docente">`administrador`.`docente`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="68403838494e7767724475275e6c266e">
